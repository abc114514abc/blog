...
export const blogPosts = [
  ...
  { id: '024', file: '24.fastapi', title: 'Pydantic校验学习', summary: '学习Pydantic对fastapi的数据进行校验', date: '2025-7-23' },
  { id: '025', file: '25.version', title: '软件版本号的规范', summary: '记录开发过程总版本号命名的问题', date: '2025-7-28' },
]
